...
export const createCaretakerService = async (adminUser, data) => {
  ...
  if (!fullName || !emailAddress || !password || !userName) throw new Error("Missing required fields");
...
export const deleteUserService = async (adminUser, userId) => {
  ...
  if (user.ID === adminUser.ID) throw new Error("You cannot delete your own account");
