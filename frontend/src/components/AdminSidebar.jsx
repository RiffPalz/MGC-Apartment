...
import {
  FaBars, FaMoneyCheckAlt, FaHouseUser, FaDoorClosed,
  FaChevronLeft, FaHistory, FaCog, FaFileSignature,
} from "react-icons/fa";
        ...
        {MENU.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <span className={`font-NunitoSans text-sm font-semibold whitespace-nowrap transition-all duration-300 origin-left
