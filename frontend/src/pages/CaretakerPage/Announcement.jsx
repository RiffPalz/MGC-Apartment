...
import {
  ...
  updateAnnouncement,
  deleteAnnouncement,
} from "../../api/caretakerAPI/AnnouncementAPI";
    ...
    <>
      <style>{`
        @media print {
          ...
          #ann-print { position: absolute; left: 0; top: 0; width: 100%; font-family: Arial, sans-serif; font-size: 11pt; }
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3 justify-end pt-2">
                {(form.announcementTitle || form.announcementMessage || editingId) && (
                  <button type="button" onClick={handlePreCancel}
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
            <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between">
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-center w-full md:w-auto">
                <div className="overflow-x-auto custom-scrollbar w-full sm:w-auto pb-1 sm:pb-0">
                  ...
                  <div key={a.ID} className="p-5 sm:p-6 hover:bg-slate-50/80 transition-colors group">
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-slate-600 leading-relaxed line-clamp-3 whitespace-pre-wrap">{a.announcementMessage}</p>
                      </div>
                      <div className="flex items-center gap-2 shrink-0 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                        <button onClick={() => setViewModal(a)}
                          className="flex-1 sm:flex-none text-[10px] font-bold text-blue-600 bg-blue-50 sm:bg-transparent px-3 py-2 sm:p-2 rounded-md hover:bg-blue-100 transition-all uppercase tracking-widest border border-blue-100 sm:border-transparent active:scale-95">
                          View
                        </button>
                        <button onClick={() => handleEdit(a)}
                          className="flex-1 sm:flex-none text-[10px] font-bold text-[#db6747] bg-orange-50 sm:bg-transparent px-3 py-2 sm:p-2 rounded-md hover:bg-orange-100 transition-all uppercase tracking-widest border border-orange-100 sm:border-transparent active:scale-95 flex justify-center items-center gap-1.5">
                        ...
                        <button onClick={() => setConfirmDelete(a)}
                          className="flex-1 sm:flex-none text-[10px] font-bold text-red-500 bg-red-50 sm:bg-transparent px-3 py-2 sm:p-2 rounded-md hover:bg-red-100 transition-all uppercase tracking-widest border border-red-100 sm:border-transparent active:scale-95 flex justify-center items-center gap-1.5">
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex justify-center items-center p-4 animate-in fade-in duration-200 no-print">
          <div className="bg-white rounded-2xl w-full max-w-xl shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
            ...
            <div className="px-6 py-4 border-t border-slate-100 bg-slate-50 flex flex-col-reverse sm:flex-row justify-end gap-3 shrink-0">
              ...
              <button onClick={() => { handleEdit(viewModal); setViewModal(null); }}
