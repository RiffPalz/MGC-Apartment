    ...
    <>
      ...
      <style>{`
        @media print {
          ...
          #maint-print { position: absolute; left: 0; top: 0; width: 100%; }
      ...
      <div id="maint-print" className="hidden print:block">
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr>{["Unit","Tenant","Request Title","Category","Start Date","End Date"].map((h) => (
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
          <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <button onClick={load}
                className="px-4 py-2.5 rounded-lg text-xs font-bold bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 transition-all shadow-sm uppercase tracking-widest">
                Refresh
              </button>
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 no-print animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 animate-in zoom-in-95 duration-200 border border-slate-100">
            ...
            <p className="text-sm text-slate-500 mb-6 leading-relaxed">
              Are you sure you want to remove "<span className="font-bold text-slate-900">{confirmDelete.title}</span>"? This action cannot be undone.
            </p>
