...
function Home() {
  ...
  const config = {
    ...
    gallery_images: LOCAL_GALLERY.map((def, i) => {
      ...
      const isValidWebUrl =
        remote && remote.url && remote.url.startsWith("http");
    ...
    <div className="overflow-x-hidden bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div
            data-aos="fade-up"
            className="mb-10 sm:mb-16 text-center flex flex-col items-center"
          >
            <h4 className="text-[#db6747] font-bold tracking-widest uppercase text-xs sm:text-sm mb-2">
              Our Property
            </h4>
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-OswaldRegular uppercase text-slate-900">
              Overall Building
            </h2>
          ...
          <div data-aos="fade-up">
            <GalleryLayout
              items={config.gallery_images.map((img, i) => ({
                id: i + 1,
                src: img.url,
                caption: img.caption,
                slot: img.slot,
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="w-full md:w-1/2" data-aos="fade-right">
            <div className="relative p-3 sm:p-4 border-2 border-[#db6747] rounded-xl bg-white shadow-xl">
              <img
                src={img1}
                alt="MGC Building"
                className="w-full h-56 sm:h-80 md:h-[500px] object-cover rounded-lg"
              />
              <div className="absolute -bottom-6 -left-6 bg-[#db6747] text-white p-5 sm:p-8 hidden sm:block rounded-2xl shadow-xl">
                <p className="font-OswaldRegular text-3xl sm:text-4xl drop-shadow-sm">
                  10+
                </p>
          ...
          <div
            className="w-full md:w-1/2 space-y-5 sm:space-y-8"
            data-aos="fade-left"
          >
            <h4 className="text-[#db6747] font-bold tracking-widest uppercase text-xs sm:text-sm">
              Established 2015
            </h4>
            <h2 className="text-3xl sm:text-5xl font-OswaldRegular uppercase text-slate-900 leading-tight">
              About MGC Building
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-[#fff7f1] rounded-3xl p-8 sm:p-10 lg:p-12 border border-[#F2DED4] shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow duration-300">
              ...
              <div className="relative z-10 space-y-6">
                <div>
                  <h4 className="text-[#db6747] font-bold uppercase text-xs tracking-[2px] mb-3">
                    Monthly Rate
                  </h4>
                  <div className="flex items-baseline gap-2">
                    <h3 className="text-4xl sm:text-5xl lg:text-6xl font-OswaldRegular text-slate-900">
                      ₱{parseInt(config.monthly_rate)}
                    </h3>
                    <span className="text-slate-500 font-NunitoSans font-bold uppercase tracking-widest text-[11px] sm:text-xs">
                      / Month
                    </span>
                  </div>
                </div>

                <div className="w-12 h-px bg-[#db6747]/30" />

                <p className="text-slate-600 font-NunitoSans text-base sm:text-lg leading-relaxed font-medium">
                ...
                <div className="inline-flex items-center gap-2.5 bg-white px-4 py-2 rounded-xl border border-[#F2DED4] shadow-sm mt-2">
                  ...
                  <span className="text-slate-700 font-bold text-[10px] uppercase tracking-[2px]">
                    No Pets Allowed
                  </span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 lg:p-12 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow duration-300">
              ...
              <div className="relative z-10 space-y-6">
                <div>
                  <h4 className="text-slate-400 font-bold uppercase text-xs tracking-[2px] mb-3">
                    Deposit Terms
                  </h4>
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-OswaldRegular text-slate-900 uppercase">
                    Security & Terms
                  </h3>
                </div>
                ...
                <ul className="space-y-4 text-slate-600 font-NunitoSans text-base sm:text-lg font-medium">
                  {config.deposit_terms
                    .split(",")
                    .map((t) => t.trim())
                    .map((t) => (
                      <li key={t} className="flex items-start gap-3.5">
                        <div className="mt-2 w-1.5 h-1.5 rounded-full bg-[#db6747] shrink-0" />
                        <span>{t}</span>
                      </li>
                    ))}
                </ul>
                ...
                {config.deposit_terms_description && (
                  <p className="text-slate-500 font-NunitoSans text-sm sm:text-base leading-relaxed italic border-l-2 border-slate-200 pl-4 mt-2">
                    {config.deposit_terms_description}
                  </p>
                )}
          ...
          <div className="space-y-8 sm:space-y-10" data-aos="fade-right">
            ...
            <div className="space-y-6 sm:space-y-8 max-w-md">
              ...
              <div className="flex flex-col gap-4 sm:gap-6 pt-2">
                {["Fast Inquiry Response", "Unit Viewing Coordination"].map(
                  (t) => (
                    <div
                      key={t}
                      className="flex items-center gap-4 bg-white px-5 py-3 rounded-xl border border-slate-100 shadow-sm w-max"
                    >
                      <div className="w-7 h-7 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0 font-black text-sm">
                        ✓
                      </div>
                      <p className="font-NunitoSans font-bold text-slate-700 uppercase text-[10px] sm:text-xs tracking-widest">
                        {t}
                      </p>
                    </div>
                  ),
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                <div className="space-y-1 sm:space-y-2">
                  <label className="block font-NunitoSans font-bold text-slate-500 text-[9px] sm:text-[10px] uppercase tracking-widest">
                    Full Name
                  </label>
                  <input
                    required
                ...
                {["Julie Pastrana Canete", "Kenneth Selencio"].map((name) => (
                  <li key={name} className="flex items-center gap-3">
                    <div className="bg-white/10 p-1.5 sm:p-2 rounded-full shrink-0">
                      <svg
                        className="w-3 h-3 sm:w-4 sm:h-4 text-[#db6747]"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
