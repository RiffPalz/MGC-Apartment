...
export default function AccountSetting() {
  ...
  return (
    <div className="bg-[#FFF9F6] min-h-screen w-full px-3 sm:px-5 md:px-10 py-5 md:py-10 text-[#330101]">
      <div className="max-w-3xl mx-auto space-y-5 md:space-y-6">

        {/* PROFILE CARD */}
        <div className="bg-white rounded-[2rem] border border-[#F2DED4] shadow-sm overflow-hidden">
          <div className="h-20 sm:h-24 bg-[#5c1f10] relative">
            <div className="absolute -bottom-9 sm:-bottom-10 left-5 sm:left-7">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-[#FDF2ED] border-4 border-white flex items-center justify-center text-[#D96648] font-black text-xl sm:text-2xl shadow-md">
                {initials}
              </div>
            </div>
          </div>
          <div className="pt-12 sm:pt-14 px-5 sm:px-7 pb-5 sm:pb-7">
            <h2 className="text-base sm:text-lg font-black text-[#330101]">{profile?.fullName}</h2>
        ...
        {/* PERSONAL INFO FORM */}
        <div className="bg-white rounded-[2rem] border border-[#F2DED4] shadow-sm overflow-hidden">
          <div className="px-5 sm:px-7 py-4 sm:py-5 border-b border-[#F2DED4] flex items-center gap-3">
          ...
          <div className="p-5 sm:p-7 space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <ReadOnlyField icon={<FaUsers size={13} />} label="Number of Residents" value={profile?.numberOfTenants ? `${profile.numberOfTenants} Resident${profile.numberOfTenants > 1 ? "s" : ""}` : "Not set"} />
            </div>
