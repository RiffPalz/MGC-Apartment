    ...
    <div className="bg-[#FFF9F6] min-h-screen w-full px-4 sm:px-6 md:px-10 py-6 md:py-10 text-[#330101]">
      ...
      {pdfModal && contract.contract_file && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex flex-col">
          ...
          {/* PDF Viewer */}
          <div className="flex-1 overflow-auto bg-[#1a1a1a] flex flex-col items-center py-6 gap-4">
            <Document
            ...
            {/* Page controls */}
            {numPages && numPages > 1 && (
              <div className="flex items-center gap-4 bg-black/40 px-5 py-2.5 rounded-full">
